...
namespace Spacebuilder.Common
{
    ...
    public class UrlRoutingRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
                "Alipay_Common", // Route name
                "Alipay/{action}" + extensionForOldIIS, // URL with parameters
                new { controller = "Alipay", action = "Pay" } // Parameter defaults
            );

            context.MapRoute(
                "Alipay_notify_url", // Route name
                "Alipay/notify_url", // URL with parameters
                new { controller = "Alipay", action = "notify_url" } // Parameter defaults
            );

            context.MapRoute(
                "Alipay_return_url", // Route name
                "Alipay/return_url", // URL with parameters
                new { controller = "Alipay", action = "return_url" } // Parameter defaults
            );
            ...
            context.MapRoute(
            "ControlPanel_Content_ManageVote", // Route name
            "ControlPanel/Content/ManageVote" + extensionForOldIIS, // URL with parameters
            new { controller = "ControlPanelContent", action = "ManageVote", CurrentNavigationId = "20000018" } // Parameter defaults
            );
            context.MapRoute(
            ...
            context.Routes.MapHttpHandler<UEditorHandler>("UMditor", "Handlers/UMditor.ashx");
