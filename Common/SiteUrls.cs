...
namespace Spacebuilder.Common
{
    ...
    public class SiteUrls
    {
        ...
        /// <param name="textAreaId">TextAreaId</param>
        /// <returns></returns>
        public string _AddVote(string textAreaId = null)
        {
            RouteValueDictionary routeValue = new RouteValueDictionary();
            if (!string.IsNullOrEmpty(textAreaId))
            {
            ...
            return CachedUrlHelper.Action("_AddVote", "Channel", "Common", routeValue);
        }
        ...
        /// <param name="textAreaId">TextAreaId</param>
        /// <returns></returns>
        public string _AddNewVote(string textAreaId = null)
        {
            RouteValueDictionary routeValue = new RouteValueDictionary();
            if (!string.IsNullOrEmpty(textAreaId))
            {
            ...
            return CachedUrlHelper.Action("_AddNewVote", "Channel", "Common", routeValue);
        }
        ...
        /// <param name="textAreaId">TextAreaId</param>
        /// <returns></returns>
        public string VoteDail(long voteId)
        {
            RouteValueDictionary routeValue = new RouteValueDictionary();          
                routeValue = new RouteValueDictionary() { { "voteId", voteId } };
                return CachedUrlHelper.Action("VoteDetail", "Channel", "Common", routeValue);
        }
        ...
        /// <param name="textAreaId">TextAreaId</param>
        /// <returns></returns>
        public string VoteResult(long voteId)
        {
            RouteValueDictionary routeValue = new RouteValueDictionary();
            routeValue = new RouteValueDictionary() { { "voteId", voteId } };
            return CachedUrlHelper.Action("_ResultVote", "Channel", "Common", routeValue);
        }
        ...
        /// <returns></returns>
        public string EditVote(long? voteId)
        {
            RouteValueDictionary routeValue = new RouteValueDictionary();
            if (voteId.HasValue && voteId.Value > 0)
            {
                routeValue = new RouteValueDictionary() { { "voteId", voteId } };
            }
            return CachedUrlHelper.Action("_AddVote", "Channel", "Common", routeValue);
        ...
        /// </summary>
        /// <returns></returns>
        public string VoteUpdateAuditStatus(bool isApproved = true, long? id = null)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            if (id.HasValue)
            {
            ...
            return CachedUrlHelper.Action("_UpdateAuditStatus", "ControlPanelContent", "Common", dic);
        }
        ...
        /// <returns></returns>
        public  string _DeleteVoteThreads( string spaceKey, long? voteIds = null)
        {
            RouteValueDictionary dic = new RouteValueDictionary();
            if (!string.IsNullOrEmpty(spaceKey))
            {
            ...
            if (voteIds != null)
                dic.Add("voteIds", voteIds);

            return CachedUrlHelper.Action("_DeleteVoteThreads", "ControlPanelContent", "Common", dic);
        }
        ...
        #region 投票选项图片
         ...
         /// <param name="TenantTypeId"></param>
         /// <returns></returns>
         public string _UploadVotePhoto(string TenantTypeId)
         {
             RouteValueDictionary routeValue = new RouteValueDictionary();
             routeValue = new RouteValueDictionary() { { "TenantTypeId", TenantTypeId } };
             return CachedUrlHelper.Action("_UploadVotePhoto", "Channel", "Common", routeValue);
         }

         public string _VoteOptinPhotoDetail(string TenantTypeId)
         {
             RouteValueDictionary routeValue = new RouteValueDictionary();
             routeValue = new RouteValueDictionary() { { "TenantTypeId", TenantTypeId } };
             return CachedUrlHelper.Action("_UploadVotePhoto", "Channel", "Common", routeValue);
        ...
        {
            return CachedUrlHelper.Action("PayPage", "Alipay", CommonAreaName);
        }
