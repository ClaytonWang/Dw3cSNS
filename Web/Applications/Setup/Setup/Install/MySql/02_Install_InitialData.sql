...
INSERT `tn_InitialNavigations` (`NavigationId`, `ParentNavigationId`, `Depth`, `PresentAreaKey`, `ApplicationId`, `NavigationType`, `NavigationText`, `ResourceName`, `NavigationUrl`, `UrlRouteName`, `RouteDataName`, `IconName`, `ImageUrl`, `NavigationTarget`, `DisplayOrder`, `OnlyOwnerVisible`, `IsLocked`, `IsEnabled`)
 ...
 (20000041, 20000031, 2, 'ControlPanel', 0, 1, '操作文章', '', '', 'ControlPanel_Operation_ManageOperationLogs', NULL, NULL, NULL, '_self', 20000041, 0, 1, 1),
...
INSERT `tn_AccountTypes` (`AccountTypeKey`, `ThirdAccountGetterClassType`, `AppKey`, `AppSecret`, `IsSync`, `IsShareMicroBlog`, `IsFollowMicroBlog`, `OfficialMicroBlogAccount`, `IsEnabled`) VALUES ('WeChat', 'Spacebuilder.Common.WeChatAccountGetter,Spacebuilder.Common', '', '', 0, 0, 0, '', 0);
-- 标签
